...
if("TRUE" STREQUAL "TRUE")
  set(hector_imu_tools_SOURCE_PREFIX /home/zihao/hector_quadrotor/src/hector_slam/hector_imu_tools)
  set(hector_imu_tools_DEVEL_PREFIX /home/zihao/hector_quadrotor/devel)
  ...
  set(hector_imu_tools_INSTALL_PREFIX /home/zihao/hector_quadrotor/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hector_imu_tools' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zihao/hector_quadrotor/src/hector_slam/hector_imu_tools/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  list(APPEND hector_imu_tools_EXPORTED_TARGETS ${${hector_imu_tools_dep}_EXPORTED_TARGETS})
endforeach()
